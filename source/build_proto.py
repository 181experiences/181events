...
<style>
  ...
  *{{box-sizing:border-box;-webkit-tap-highlight-color:transparent}}
  ...
  /* An uploaded picture keeps its true shape even on the marquee event: the
     kit's spec promises 1600 x 900, so no frame may quietly crop it. The
     taller marquee treatment stays for the typographic card, which cannot. */
  .ehero.photo.tall{{aspect-ratio:16/9}}
...
<!--MINE--><div class="statebox" style="margin-top:14px"><h2>You&rsquo;re {{MINESTATE}}</h2>
<p>{{MINENAME}}, registered {{MINEWHEN}}. Nothing more to do; on the day, give the event name at the
181 Fremont lobby. Plans changed? Write to the front desk at concierge@181sf.com and we&rsquo;ll set the
list right.</p></div><!--/MINE-->
