...
<section class="screen" id="scr-editor"><div class="wrap">
  ...
  <div class="form">
    ...
    <div class="field f-full"><label class="fl" for="f-desc">Description</label>
      <textarea class="inp" id="f-desc" rows="7" placeholder="Write it as if the reader knows nothing about the event. A blank line starts a new paragraph."></textarea></div>
