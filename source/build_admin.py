...
<style>
  ...
  *{{box-sizing:border-box;-webkit-tap-highlight-color:transparent}}
  ...
  /* phones: the brand tightens so the identity gets real width, Sign out tucks
     under the email, and the address holds one line, whoever's it is */
  @media(max-width:700px){{
    .topbar .inner{{gap:10px}}
    .brand{{font-size:13px;letter-spacing:.13em}}
    .brand small{{font-size:8.5px;letter-spacing:.09em}}
    .whowrap{{flex-direction:column;align-items:flex-end;gap:7px}}
    .who{{font-size:11px}}
    .who strong{{font-size:12px;white-space:nowrap;overflow-wrap:normal;overflow:hidden;text-overflow:ellipsis;max-width:58vw}}
...
<section class="screen" id="scr-editor"><div class="wrap">
  ...
  <div class="form">
    ...
    <div class="field f-full" id="ed-address" style="display:none"><div class="flrow"><label class="fl" for="f-address">Street address, for calendar apps</label>{info("Optional. When set, Add to My Calendar files the event at this address, so tapping the entry maps residents to the venue rather than to 181 Fremont. It also appears quietly under Where on the event page. Without it, the calendar entry carries the Location text as written.")}</div><input class="inp" id="f-address" autocapitalize="words" placeholder="384 Post St, San Francisco"></div>
