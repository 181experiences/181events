...
export const RESIDENT_TABLES = [
  ...
  `CREATE TABLE IF NOT EXISTS guests (
    ...
    name TEXT NOT NULL, plus_one TEXT,
    created TEXT NOT NULL, arrived TEXT
  )`,
  `CREATE INDEX IF NOT EXISTS guests_by_booking ON guests(booking_id, id)`,
...
export async function ensureResidentTables(env) {
  ...
  for (const col of ["arrived INTEGER", "arrived_at TEXT", "updated_by TEXT", "door_note TEXT"]) {
